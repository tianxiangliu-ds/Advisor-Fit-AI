...
register(
    "drafting",
    "写一封真诚、具体、有说服力的中文套磁邮件正文（280–420 字），用于联系导师。"
    "必须基于 payload 提供的学生经历与导师研究，把「学生具体经历」与「导师具体研究」"
    "自然地连接起来——例如点出导师某篇论文/某个方向与你的项目或技能如何契合；"
    "不要空泛罗列、不要照搬原文措辞。学生通常是本科生或硕士生，不要把学生写成与导师"
    "学术水平相当；应突出已经证实的执行能力、方法能力、学习速度与可迁移优势，清楚回答"
    "导师为什么值得进一步了解这名学生。可以优化表达和组织重点，但不得新增经历、技能、"
    "成果、奖项或研究结论。"
    "优先选择 payload 中年份最新、且有证据的论文或方向；较早论文只能在没有更新成果时使用。"
    "结构：称呼与自我介绍（1–2 句）→ 与导师近期研究的一个具体连接（2–3 句，引用真实论文/方向）"
    "→ 把 1–2 项真实学生事实组织成可执行的贡献起点（2–3 句，例如复现、实验整理、"
    "数据处理或工程实现）"
    "→ 明确询问（1 句，如招生名额或能否进一步交流）→ 落款。"
    ...
    "避免自封优秀、能力突出等空洞评价；用具体事实让优势自然成立。"
    "语气专业、积极、得体，体现对导师研究的真实理解，而非模板套话。",
)
